...
function linkPrecondition(options) {
  app.factory.assert(
    options.tailModel instanceof type.AzureElement &&
      options.headModel instanceof type.AzureElement,
    Mustache.render(ERR_INVALID_LINK, options.modelType),
  );
}

// Create Azure diagram function ..................................................
...
function diagramFn(parent, options) {
  ...
  if (parent instanceof type.Project) {
    model = new type.AzureModel();
    model.name = Element.getNewName(parent.ownedElements, "AzureModel");
    model._parent = parent;
    diagram = new type.AzureDiagram();
...
app.factory.registerDiagramFn("AzureDiagram", diagramFn);

// Create Model ............................................................

app.factory.registerModelFn("AzureModel", _modelFn);

// Create Model And View ...................................................

app.factory.registerModelAndViewFn("AzureElement", _modelAndViewFn);
app.factory.registerModelAndViewFn("AzureGroup", _modelAndViewFn);
app.factory.registerModelAndViewFn("AzureService", _modelAndViewFn);
app.factory.registerModelAndViewFn("AzureCallout", _modelAndViewFn, {
  modelInitializer: (model) => {
    model.name = "1";
  },
});
app.factory.registerModelAndViewFn("AzureConnector", _directedRelationshipFn, {
  precondition: linkPrecondition,
});

// Create View .............................................................

app.factory.registerViewOfFn("AzureDiagram", _viewOnDiagramFn);
