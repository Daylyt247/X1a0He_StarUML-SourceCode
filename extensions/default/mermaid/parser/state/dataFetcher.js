...
function stateDomId(
  ...
  const typeStr =
    type !== null && type.length > 0 ? `${typeSpacer}${type}` : "";
...
function insertOrUpdateNode(nodes, nodeData, classes) {
  ...
  if (nodeData.cssClasses) {
    ...
    nodeData.cssClasses.split(" ").forEach((cssClass) => {
      ...
      if (classDef) {
        nodeData.cssCompiledStyles = [
          ...((_a = nodeData.cssCompiledStyles) !== null && _a !== void 0
            ? _a
            : []),
          ...classDef.styles,
        ];
...
function getClassesFromDbInfo(dbInfoItem) {
  ...
  return (_b =
    (_a =
      dbInfoItem === null || dbInfoItem === void 0
        ? void 0
        : dbInfoItem.classes) === null || _a === void 0
      ? void 0
...
function getStylesFromDbInfo(dbInfoItem) {
  ...
  return (_a =
    dbInfoItem === null || dbInfoItem === void 0
      ? void 0
      : dbInfoItem.styles) !== null && _a !== void 0
    ? _a
    : [];
}
const dataFetcher = (
  ...
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: common.sanitizeText(itemId),
    ...
    if (parsedItem.description) {
      if (Array.isArray(newNode.description)) {
        ...
        if (
          ((_a = newNode.description) === null || _a === void 0
            ? void 0
            : _a.length) &&
      ...
      newNode.description = common.sanitizeTextOrArray(newNode.description);
    }
    // If there's only 1 description entry, just use a regular state shape
    if (
      ((_b = newNode.description) === null || _b === void 0
        ? void 0
        : _b.length) === 1 &&
      newNode.shape === SHAPE_STATE_WITH_DESC
    ) {
    ...
    if (!newNode.type && parsedItem.doc) {
      ...
      newNode.shape =
        parsedItem.type === DIVIDER_TYPE ? SHAPE_DIVIDER : SHAPE_GROUP;
