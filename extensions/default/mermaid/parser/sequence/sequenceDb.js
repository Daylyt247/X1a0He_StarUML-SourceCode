const { ImperativeState } = require("../utils");
...
class SequenceDB {
  ...
  addBox(data) {
    ...
    this.state.records.boxes.push({
      name: data.text,
      wrap: (_a = data.wrap) !== null && _a !== void 0 ? _a : this.autoWrap(),
      fill: data.color,
      actorKeys: [],
    });
  ...
  addActor(id, name, description, type) {
    ...
    if (old) {
      ...
      if (
        ...
        old.box &&
        this.state.records.currentBox !== old.box
      ) {
        throw new Error(
    ...
    this.state.records.actors.set(id, {
      ...
      wrap:
        (_a = description.wrap) !== null && _a !== void 0
          ? _a
          : this.autoWrap(),
      ...
      actorCnt: null,
      rectData: null,
      type: type !== null && type !== void 0 ? type : "participant",
    });
    if (this.state.records.prevActor) {
      const prevActorInRecords = this.state.records.actors.get(
  ...
  addMessage(idFrom, idTo, message, answer) {
    ...
    this.state.records.messages.push({
      ...
      wrap:
        (_a = message.wrap) !== null && _a !== void 0 ? _a : this.autoWrap(),
      answer: answer,
    });
  }
  addSignal(idFrom, idTo, message, messageType, activate = false) {
    ...
    if (messageType === this.LINETYPE.ACTIVE_END) {
      const cnt = this.activationCount(
        idFrom !== null && idFrom !== void 0 ? idFrom : "",
      );
      if (cnt < 1) {
    ...
    this.state.records.messages.push({
      ...
      wrap:
        (_b =
          message === null || message === void 0 ? void 0 : message.wrap) !==
          null && _b !== void 0
          ? _b
          : this.autoWrap(),
      type: messageType,
  ...
  autoWrap() {
    ...
    // return false;
    return (_b =
      (_a = {}.sequence) === null || _a === void 0 ? void 0 : _a.wrap) !==
      null && _b !== void 0
      ? _b
      : false;
  }
  ...
  parseBoxData(str) {
    ...
    let color = (match === null || match === void 0 ? void 0 : match[1])
      ? match[1].trim()
      : "transparent";
    let title = (match === null || match === void 0 ? void 0 : match[2])
      ? match[2].trim()
      : undefined;
    // check that the string is a color
    if (window === null || window === void 0 ? void 0 : window.CSS) {
    ...
    return {
      text: cleanedText ? sanitizeText(cleanedText) : undefined,
      color,
      wrap,
    };
  }
  addNote(actor, placement, message) {
    ...
    this.state.records.messages.push({
      ...
      message: message.text,
      wrap:
        (_b = message.wrap) !== null && _b !== void 0 ? _b : this.autoWrap(),
  ...
  addLinks(actorId, text) {
    ...
    // JSON.parse the text
    try {
      let sanitizedText = sanitizeText(text.text);
  ...
  getActorProperty(actor, key) {
    if (
      (actor === null || actor === void 0 ? void 0 : actor.properties) !==
      undefined
    ) {
...
module.exports = { SequenceDB, LINETYPE, ARROWTYPE, PLACEMENT };
